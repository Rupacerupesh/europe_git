...
class NavigationController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('backend.navigation.table',compact('navigation_list','navigation_parent','navigation_children'));
    }
...
//        return ($parents_list);
    ...
    public function edit($id)
    {
        ...
        $parents_list=array_replace_recursive($parents_list,Navigation::where('id','!=',$id)->pluck('title','id')->toArray());
